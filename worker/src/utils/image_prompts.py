...
_DEFAULT_PROMPTS = {
    "main": "产品：{{title}}。这是电商营销主图，适合俄罗斯消费者的审美偏好。画面以产品为视觉中心，占比不低于60%。背景是自然融入的场景环境，柔和自然光打在产品上，清晰呈现材质纹理与细节。整体调性简洁高级。画面中不得出现任何水印、logo、品牌标识、价格标签、运费信息、促销文案、二维码、物流信息、退换货说明、地址、电话、联系方式或店铺名称。",
    "social_proof": "产品：{{title}}。这是一张电商买家好评展示图，适合俄罗斯消费者的审美偏好，用于激发消费者信任和购买欲望。画面以视觉化方式呈现产品的高口碑评价，可包含星级评分、真实使用场景暗示、群体口碑传播氛围。整体调性温暖可信，营造热销爆款的紧迫感。画面中不得出现任何水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式或店铺名称。",
    ...
    "scene_1": "产品：{{title}}。场景图：产品在{{scene_context}}中实际使用的画面，适合俄罗斯消费者的审美偏好。产品清晰可见，场景真实自然。禁止任何水印、logo、价格、运费、促销、二维码、电话号码、地址、店铺名称（俄语/中文/英文均禁止）。",
    "scene_2": "产品：{{title}}。场景图：产品在{{scene_context}}中的近距离特写，适合俄罗斯消费者的审美偏好。浅景深，背景虚化，产品主体清晰锐利。禁止任何水印、logo、价格、运费、促销、二维码、电话号码、地址、店铺名称（俄语/中文/英文均禁止）。",
    "scene_3": "产品：{{title}}。场景图：产品在{{scene_context}}环境中的宽幅展示，适合俄罗斯消费者的审美偏好，适合商品卡轮播。禁止任何水印、logo、价格、运费、促销、二维码、电话号码、地址、店铺名称（俄语/中文/英文均禁止）。",
    "comparison": "产品：{{title}}。左右分栏对比展示图，适合俄罗斯消费者的审美偏好，突出产品优势与差异化卖点。禁止任何水印、logo、价格、运费、促销、二维码、电话号码、地址、店铺名称（俄语/中文/英文均禁止）。",
    "detail": "产品：{{title}}。微距细节特写图，适合俄罗斯消费者的审美偏好。展示产品材质肌理、接缝工艺、表面处理，1-3个局部放大，高清细节。禁止任何文字、数字、水印、logo、价格、运费、促销、二维码、电话号码、地址、店铺名称（俄语/中文/英文均禁止）。",
