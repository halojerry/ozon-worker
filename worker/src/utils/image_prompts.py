...
_DEFAULT_PROMPTS = {
    "main": "产品：{{title}}。生成该产品的电商营销主图。要求：创意营销风格、可包含场景化背景、突出产品卖点、适合Ozon平台商品卡首图展示、高清细节、无其他品牌logo/水印、适合俄罗斯电商平台展示、符合俄罗斯人民审美。",
    "white_bg": "产品：{{title}}。去除产品背景，生成纯白底产品图。严格要求：纯白背景(#FFFFFF)、纯产品摄影、高清细节、严格禁止任何文字/水印/标签/数字/品牌logo/二维码/联系方式/价格信息/中文字符/英文字符/促销标语、非信息图/非营销海报、专业电商产品摄影风格、产品必须与参考图一致。",
    "multi_angle": "产品：{{title}}。生成该产品的多角度实物展示图。严格要求：纯白背景(#FFFFFF)、纯产品摄影、展示产品正面/侧面/背面不同角度、高清细节清晰、无任何文字/标签/参数/logo、无水印、非信息图/非营销海报、专业电商产品摄影风格。",
    "scene_1": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，温馨氛围，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。",
    "scene_2": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，温馨氛围，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。",
    "scene_3": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，温馨氛围，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。",
    "comparison": "生成产品对比电商展示图。突出产品优势，吸引消费者购买。适合俄罗斯电商平台展示，符合俄罗斯人民审美。",
    "detail": "生成产品电商详情展示图。要求：清晰展示产品细节和材质，高清晰度，适合俄罗斯电商平台展示，符合俄罗斯人民审美。",
    "social_proof": "生成产品好评如潮展示图。要求：展示大量五星好评、高评分、买家满意等正面评价信息，营造热销爆款氛围，增加消费者信任感和购买欲望，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。",
    "variant_white_bg": "去除产品背景，生成纯白底图：要求：纯白背景（#FFFFFF），无文字水印，专业产品摄影风格。",
}
