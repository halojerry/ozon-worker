...
_DEFAULT_PROMPTS = {
    "main": "产品：{{title}}。生成该产品的电商营销主图。要求：创意营销风格、可包含场景化背景、突出产品卖点、适合Ozon平台商品卡首图展示、高清细节、适合俄罗斯电商平台展示、符合俄罗斯人民审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    ...
    "scene_1": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    "scene_2": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    "scene_3": "生成产品电商场景图。要求：展示产品在{{scene_context}}场景中的使用效果，展示产品在特殊场景中的独特应用，吸引消费者兴趣，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    "comparison": "生成产品对比电商展示图。突出产品优势，吸引消费者购买。适合俄罗斯电商平台展示，符合俄罗斯人民审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    "detail": "生成产品电商详情展示图。要求：清晰展示产品细节和材质，高清晰度，适合俄罗斯电商平台展示，符合俄罗斯人民审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
    "social_proof": "生成产品好评如潮展示图。要求：展示大量五星好评、高评分、买家满意等正面评价信息，营造热销爆款氛围，增加消费者信任感和购买欲望，适合俄罗斯电商平台展示，适合俄罗斯消费者审美。画面中严禁出现任何文字、数字、水印、logo、价格、运费、促销、二维码、物流信息、退换货说明、地址、电话、联系方式、店铺名称等字样（俄语/中文/英文均禁止）。",
