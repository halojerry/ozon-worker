...
| `envelope.draft.weight_from_pool_variant` | bool | ❌ | data-pool批6 | 重量来自 data pool variant 真值（data-pool 批 6.3，区别于估算/兜底），与 `weight_estimated` 互斥语义位 |
