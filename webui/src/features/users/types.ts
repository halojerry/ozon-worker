...
export const userSchema = z.object({
  ...
  referral_level1_user_id: z.number().optional(),
  referral_level2_user_id: z.number().optional(),
  commission_balance: z.number().optional(),
  commission_frozen: z.number().optional(),
  commission_withdrawn: z.number().optional(),
